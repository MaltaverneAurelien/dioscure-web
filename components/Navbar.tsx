        ...
        <div className="flex flex-nowrap justify-between items-center mx-auto">
          ...
          {session === null && (
            <button
              ...
              className="bg-twitch_purple hover:bg-violet-800 focus:ring-1 focus:ring-white text-white flex rounded-full items-center text-sm px-4 py-1 w-max whitespace-nowrap"
            >
              <BsTwitch className="float-left text-base mr-2" />
          ...
          {session !== null && (
            <div className="relative inline-block text-left">
              ...
              >
                <li className="py-1">
                  <a href="#account" className="text-white px-4 py-2 text-sm flex items-center">
                    <CgProfile className="float-left mr-2" />
                    Profile
                  </a>
                </li>
                <li className="py-1">
                  <a href="#" className="text-white block px-4 py-2 text-sm">
                    ...
                    >
                      <BiLogOut className="float-left mr-2" />
                      Se déconnecter
                    </button>
                  </a>
                </li>
